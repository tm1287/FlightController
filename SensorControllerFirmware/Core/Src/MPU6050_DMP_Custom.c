...
#include <MPU6050_DMP_Custom.h>

#define MPU6050_DMP_CODE_SIZE       1929    // dmpMemory[]
#define MPU6050_DMP_CONFIG_SIZE     192     // dmpConfig[]
#define MPU6050_DMP_UPDATES_SIZE    47      // dmpUpdates[]

const uint8_t dmpMemoryCustom[MPU6050_DMP_CODE_SIZE] = {
	/* bank # 0 */
...
uint8_t MPU6050_InitializeDMP(MPU6050 *dev, I2C_HandleTypeDef *i2cHandle){
	...
	//Reset MPU6050, good to delay for 50 ms after
	uint8_t resetBit = 7;
	MPU6050_WriteByte(dev, MPU6050_REG_PWR_MGMT_1, &resetBit);
	HAL_Delay(50);

	uint8_t sleepData = 0;
	MPU6050_WriteByte(dev, MPU6050_REG_PWR_MGMT_1, &sleepData);

	MPU6050_SetMemoryBank(dev, 0x10, true, true);
	MPU6050_SetMemoryStartAddress(dev, 0x06);
	MPU6050_SetMemoryBank(dev, 0, false, false);

	MPU6050_SetSlaveAddress(dev, 0, 0x7F);
	MPU6050_SetI2CMasterModeEnabled(dev, false);
	MPU6050_SetSlaveAddress(dev, 0, 0x68);
	MPU6050_ResetI2CMaster(dev);
	HAL_Delay(50);
